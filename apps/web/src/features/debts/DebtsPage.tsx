...
import { AlertCircle, BadgeDollarSign, CreditCard, Pencil, PieChart as PieIcon, Info } from "lucide-react";
...
export default function DebtsPage() {
  ...
  return (
    <AppShell>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-6 shadow-sm">
          ...
          <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center md:w-auto">
              ...
              >
                <SelectTrigger className="w-full sm:w-[140px] bg-white/70">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {(years.length > 0
      ...
      <div className="mb-8 rounded-2xl border border-emerald-100 bg-emerald-50/60 p-4 text-sm text-emerald-900">
